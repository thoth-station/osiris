...
_LOGGER.info(f"This is Osiris API v{__version__}")
...
app.add_api(
    ...
    arguments={"title": "Osiris API"},
    resolver=RestyResolver("osiris.api"),
...
metrics.info("osiris_api_info", "Osiris API info", version=__version__)
